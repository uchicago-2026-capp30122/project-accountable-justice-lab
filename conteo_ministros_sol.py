...
# Diccionario basado en tus listas
...
def is_mentioning(text, target_name):
    ...
    for part in target_parts:
        # Solo buscamos apellidos o nombres significativos (evita "de", "n", "i")
...
def run_count():
    # Inicializamos conteos para que incluso los que tienen 0 aparezcan en la gráfica
    ...
    with open(DEFAULT_CSV, "r", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            # FILTRO CRUCIAL: Solo busca los ministros que corresponden a ESE año
    ...
    with open(OUTPUT_CSV, "w", encoding="utf-8", newline="") as f:
        ...
        # Aseguramos que se escriban los datos según tu estructura anual
